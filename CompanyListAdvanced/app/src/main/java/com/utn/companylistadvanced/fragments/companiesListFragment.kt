...
class companiesListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        companiesList.add(Company("Apple", "Alabama", 1425, "https://www.apple.com/ac/structured-data/images/knowledge_graph_logo.png?202106030101", 1200))
        companiesList.add(Company("Microsoft", "Alabama", 33, "https://www.apple.com/ac/structured-data/images/knowledge_graph_logo.png?202106030101", 100))
        companiesList.add(Company("Bethesda", "Puerto Santa Maria", 232, "https://www.apple.com/ac/structured-data/images/knowledge_graph_logo.png?202106030101", 12200))
        companiesList.add(Company("Google", "Villa Langostura", 44, "https://www.apple.com/ac/structured-data/images/knowledge_graph_logo.png?202106030101", 1500))
        companiesList.add(Company("2K", "Mexico", 4325, "https://www.apple.com/ac/structured-data/images/knowledge_graph_logo.png?202106030101", 900))
